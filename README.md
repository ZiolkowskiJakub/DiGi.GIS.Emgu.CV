...
**DiGi.GIS.Emgu.CV** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.GIS.Emgu.CV](DiGi.GIS.Emgu.CV)** (Path: `DiGi.GIS.Emgu.CV\DiGi.GIS.Emgu.CV`)
